<?php
    class Concours {
        ...
        public function resultats() { return $this->_resultats; }
        ...
        public function setResultats($resultats) { $this->_resultats = $resultats; }

        public static function selectBDD($idconcours) {
            global $wpdb;
            // chargement d'un Club
            $sql = "SELECT  co_idconcours, co_idclub, co_type, co_saison, co_datedebut, co_datefin, co_desc, co_resultats FROM " . $wpdb->prefix . "gctaa_concours WHERE co_idconcours = ".$idconcours;
        ...
        public function insertBDD() {
            ...
            $result = $wpdb->insert(
                ...
                array('co_idconcours' => $this->idconcours(),'co_idclub' => $this->idclub(),'co_type' => $this->type(),'co_saison' => $this->saison(),'co_datedebut' => $this->datedebut(),'co_datefin' => $this->datefin(),'co_desc' => $this->desc(),'co_resultats' => $this->resultats()),
        ...
        public static function updateBDD($idconcours, $concours) {
            ...
            $result = $wpdb->update(
                $wpdb->prefix . 'gctaa_concours',
                array( 'co_idclub' => $concours->idclub(),'co_type' => $concours->type(),'co_saison' => $concours->saison(),'co_datedebut' => $concours->datedebut(),'co_datefin' => $concours->datefin(),'co_desc' => $concours->desc(),'co_resultats' => $concours->resultats()),
        ...
        public static function afficheListe() {
            ...
            $strRetour = $strRetour . '     <th>Résultats chargés</th>';
            ...
            foreach ($listeConcours as $concours) {
                ...
                $strRetour = $strRetour . '<td>'.$concours->resultats().'</td>';
