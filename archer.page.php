<?php
    ...
    function admin_ajoute_archer($wp_gctaa) {
        ...
        if ( isset($_POST[ $hidden_field_name ]) ) {
            if ($_POST[ $hidden_field_name ] == "A" ) {
                // On execute l'ajout
                $licence =  verif_archer_licence($_POST[ 'licence' ]);
                $nom =  verif_archer_nom($_POST[ 'nom' ]);
                $prenom =  verif_archer_prenom($_POST[ 'prenom' ]);
                $datenaissance =  $_POST[ 'datenaissance' ];
                $mail =  verif_archer_mail($_POST[ 'mail' ]);
                $photo =  $_POST[ 'photo' ];
                list($jour, $mois, $annee) = explode('/', $datenaissance);
                $date=$annee."-".$mois."-".$jour;

                if(isset($licence) && isset($nom) && isset($prenom)){
    ...
    function verif_archer_licence($licence){
    ...
    function verif_archer_prenom($prenom){
    ...
    function verif_archer_mail($adresse){
